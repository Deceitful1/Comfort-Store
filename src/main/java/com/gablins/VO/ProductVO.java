...
public class ProductVO extends RepresentationModel<ProductVO>
{
    ...
    public ProductVO(Long id, String name, String description, double price, int quantity, String url, String category)
    {
        this.id = id;
        this.name = name;
    ...
    {
        return new ProductVO(product.getId(), product.getName(), product.getDescription(), product.getPrice(), product.getQuantity(), product.getImageUrl(), product.getCategory());
    }
